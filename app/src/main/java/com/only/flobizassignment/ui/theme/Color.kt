package com.only.flobizassignment.ui.theme
...
val background = Color(0xFFF2F1FF)
...
val colorSecondaryVariant = Color(0xFFF7F7F7)
...
val textColorPrimary = Color(0xFF353452)
val textColorSecondary = Color(0xFF767587)
val textColorTertiary = Color(0xFFA1A1AB)
val colorControlNormal = Color(0xFFA1A1AB)